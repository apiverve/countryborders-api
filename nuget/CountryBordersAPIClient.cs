...
namespace APIVerve.API.CountryBorders
{
    ...
    /// <summary>
    /// Client for the CountryBorders API
    /// </summary>
    public class CountryBordersAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/countryborders";
        ...
        public CountryBordersAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CountryBordersAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CountryBordersAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CountryBordersQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CountryBordersQueryOptions options)
        {
        ...
        public ResponseObj Execute(CountryBordersQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CountryBordersQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CountryBordersQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CountryBordersQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CountryBordersQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CountryBordersQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CountryBordersQueryOptions options)
        {
