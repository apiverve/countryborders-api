...
namespace APIVerve\Countryborders;
...
/**
 * Client for the Country Borders API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://countryborders.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/countryborders';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CountrybordersClient] {$message}\n";
        }
    }
}
