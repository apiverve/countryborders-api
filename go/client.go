// Package countryborders provides a Go client for the Country Borders API.
//
// For more information, visit: https://countryborders.apiverve.com?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/countryborders"
	defaultTimeout = 30 * time.Second
)

// Client is the Country Borders API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Country Borders API client.
...
// Execute makes a request to the Country Borders API with typed parameters.
//
...
//   - country (required): string - The Country 2 Letter ISO code (e.g., CA) [minLength: 2, maxLength: 2]
